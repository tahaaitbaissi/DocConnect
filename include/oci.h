...
/* 
   ...
   MODIFIED   (MM/DD/YY)
   apfwkr      09/13/24 - CI# 37054708 of siyuzha_bug-36745130 from main
   svhwang     08/28/24 - Bug 36996184: Rename Flex txn to Sessionless txn
   svhwang     08/19/24 - CI# 36960820 of Proj 87498 (Bug 36545327) from main
   siyuzha     08/05/24 - Bug 36745130: added OCI_BIND_RESERVED_4
   ssappara    06/16/24 - Bug 35882383: Add OCI_SUBSCRIPTION_REGISTER and
                          OCI_SUBSCRIPTION_UNREGISTER
   mearumug    06/09/24 - CI# 36713038 of mearumug_bug-36611959 from main
   mearumug    05/23/24 - Bug 36611959: Add BINARY format for vector
   apfwkr      03/29/24 - CI# 36460356 of kneel_bug-36407258 from main
   sroesch     03/29/24 - Bug 36258254: CSQ needs to use predefined ATPD svcs
   kneel       03/26/24 - Bug 36407258: note OCI_PIECEWISE as unused
   maravish    03/25/24 - Bug 35408216: Add OCI_ATTR_SODA_NATIVE
   apfwkr      03/24/24 - CI# 36438439 of taranand_bug-36421282 from main
   taranand    03/20/24 - Bug 36421282: add OCI_ATTR_VECTOR_MAX_STRING_SIZE
   karbitod    01/31/24 - Bug 32166739: add OCI_ATTR_RESERVED_706-711
   xzhzhou     01/26/24 - Bug 36038967: add OCI_ATTR_RESERVED_705
   rphillip    01/10/24 - Vector support
   maravish    02/13/24 - Bug 35408216: Add OCI_ATTR_SODA_NATIVE
   maravish    01/04/24 - Bug 35408216: Add OCI_ATTR_SODA_NATIVE
   nkedlaya    01/04/24 - Add resumable txn flag
   rkanodia    12/06/23 - update vector attribute number
   taranand    12/06/23 - Change vector type to format
   rkanodia    11/20/23 - Added OCI_ATTR_RESERVED_700 to resolve build break
   maravish    02/13/24 - Bug 35408216: Add OCI_ATTR_SODA_NATIVE
   nkedlaya    02/13/24 - Add resumable txn flag
   nkedlaya    12/09/23 - Add resumable txn flag
   rkanodia    12/01/23 - Bug 36030352: add vector attributes
   rajeekku    11/29/23 - Bug 35912463: expose OCI_ATTR_RESERVED_701
   xzhzhou     11/14/23 - Bug 33731648: add OCI_ATTR_RESERVED_700
   rkanodia    11/06/23 - Bug 35762464: change OCIP_ATTR_LOBPREFETCH_CHANGED
   mjaiswal    10/31/23 - bug 35575156: add OCI_AQ_RESERVED_6
   rpingte     10/20/23 - proj 100812: add vector attributes
   thbaby      10/18/23 - Bug 35895115: add OCI_ATTR_RESERVED 698 and 699
   rpingte     10/18/23 - add vector flag values
   rpingte     10/17/23 - add vector flag values
   rpingte     08/07/23 - Bug 35571206 vector type: add vector information
   bhgharu     06/29/23 - Bug 35438914: Add OCI_ATTR_SERVER_TYPE values
   rkanodia    06/25/23 - Bug 35513924: Add new pipeline attributes
   thbaby      06/16/23 - Bug 35484637: add OCI_ATTR_RESERVED_690
   avnandak    06/22/23 - Bug 35494546: Add OCI_REQUEST_BEGIN_RESERVED_3
   brusures    05/02/23 - 9/10/22 - add mode OCI_SRVATCH_RESERVED7
                          IAM CBK mode OCI_PASSWORD_UPDATE
   brusures    04/25/23 - Bug 34774661: add OCI_SRVATCH_RESERVED7
   johnstew    04/06/23 - proj 95734: support tag options
   johnstew    03/15/23 - proj 95734: support SQL annotations
   ichokshi    03/05/23 - Bug 35147502: add OCI_ATTR_SUBSCR_PAYTYPE
   siyuzha     02/17/23 - Bug 35006989 :add OCI_ATTR_RESERVED_684
   johtsai     02/14/23 - Bug 34943906: Saga OCI External Coordinator Types
   chenxma     01/26/23 - Bug 33433265: Embedded OID support for SODA
   digund      01/10/23 - Bug 34826705: Added OCI_ATTR_PIPELINE_HANDLE and
                          OCI_ATTR_PIPELINE_HANDLE_TYPE.
   taranand    01/03/23 - Bug 34678057: add OCI_ATTR_LAST
   xzhzhou     12/22/22 - Bug 33896617: add OCI_ATTR_RESERVED_678
   vjitta      12/21/22 - Bug 34859933: Adding memory management layer to avoid
                          mutex contention on environment handle
   rkanodia    12/04/22 - Bug 31700375: add OCI_EXEC_RESERVED_9 exec mode
   avnandak    10/27/22 - Proj Config store: Add new 
                          OCI_ATTR_SERVER_IS_CONFIGUSR
   adalee      10/27/22 - Bug 34634953: rename ADC to True Cache   
   joalvizo    10/04/22 - Bug 33910898: Add OCI_ATTR_VBL_SEND_ALL_LOB_DATA
   sriksure    09/02/22 - Bug 31181920: Support SODA document with JSON type
   sdhamoth    10/18/22 - add OCI_ATTR_SUPPRESS_ERROR_URL
   morgiyan    09/11/22 - Bug 34587418: Add OCI_ATTR_SODA_DUALITY_VIEW_NAME
                          and OCI_SODA_KEY_METHOD_SERVER
   sriksure    09/02/22 - Bug 31181920: Support SODA document with JSON type
   xzhzhou     08/23/22 - Bug 34233572: add OCI_HTYPE_APPCONTCTX
   sriksure    06/10/22 - Bug 31820357: Add OCI_ATTR_SODA_CLIENT_ERROR
   jcremoni    05/10/22 - Bug 34154060: Add OCI_PREP2_RESERVED_12
   tbhosle     05/10/22 - 34155347: fix overlapping attribute values
   rphillip    04/25/22 - Bug 33998972: DOP to server
   sudarshs    04/07/22 - Bug 34062311: Add stats constants
   vjitta      12/03/22 - Bug 33690676 : Adding an attribute to user 
                          handle to retrievve server side lang id 
                          only to be used after connection.
   anitap      03/16/22 - Proj 93526: Support for OAUTH
   johnstew    02/07/22 - project 87299: SQL Domain support
   siyuzha     02/23/22 - Proj 82560: 
                          1. Add OCI_ATTR_SESSSTATE_CONSISTENCY 
                             and OCI_SESSSTATECONS_*
                          2. Add fncode for OCIRequestBegin 
                             and OCIRequestEnd, added OCI_ATTR_PING_INTERVAL
   rphillip    02/06/22 - Project 63600: Parallel/Shard Loader
   siyuzha     02/01/22 - Bug 33145548: added attribute OCI_ATTR_RESERVED_654
   vjitta      12/07/21 - Proj 83228: OCI Pipeline implementation
   tbhosle     12/06/21 - Proj 87515: Table DDL Notification
   thbaby      01/04/22 - Bug 33724666: add OCI_ATTR_RESERVED_646
   avnandak    12/16/21 - Proj 82578: Adding reserved mode for service pool
   anitap      11/16/21 - Proj 84234: Add OCI_ATTR_IAM_BEARER_TOKEN 
   visramam    11/16/21 - Bug 30900867: add OCI_ATTR_RESERVED_643 
   tnallath    11/11/21 - DBIAM-321: Support IAM token based DBLINK access
   sriksure    11/01/21 - Project 83238: JSON schema validation support
   johnstew    11/09/21 - Bug 33533298: TTC changes for Active Data Cache
   rkanodia    09/17/21 - Bug 33272550: add OCI_ATTR_RESERVED_638
   prramakr    09/13/21 - proj 89657: IAM token support added
   lutan       08/18/21 - Proj 84234: DB IAM token based authentication
   thbaby      07/15/21 - Bug 33121325: add OCI_ATTR_RESERVED_635
   thbaby      05/09/21 - Bug 32864233: add OCI_ATTR_RESERVED_634
   chenxma     03/19/21 - Bug 31518371: Add support for SODA sampling
   thbaby      04/03/21 - Bug 32719665: add OCI_ATTR_RESERVED_630
   sriksure    03/11/21 - Bug 32360490: Add OCISodaIndexGet, OCISodAIndexList
   nilbhatt    03/04/21 - Bug 32462577: Added mode OCI_SESSEND_RESERVED_3
   ssahu       02/25/21 - Bug 32076825: Add OCI_ATTR_RESERVER_629
   rajeekku    02/01/21 - Bug 32476121: Expose OCI_THREADED_V2 mode 
   jmmedina    01/12/21 - Add OCIKeyType for IBVCs
   jvalera     01/11/21 - Bug 32196113: Add OCI_ATTR_HAS_IS_JSON_CONSTRAINT
   nikeda      01/04/21 - Bug 32021396: Add private mode to note SODA call
   sriksure    10/05/20 - Bug 31845803: Add descriptor cache facility
   ssinabhi    09/18/20 - Bug 31524010: add OCI_ATTR_RESERVED_626
   srkarre     08/16/20 - Bug 31529411: Adding new attribute for port ranges
   xzhzhou     09/09/20 - bug 31382030: add OCI_ATTR_CONNECTION_ID
   bhammers    08/30/20 - Bug 31799648: add OCI_ATTR_OSON_COL
   xzhzhou     08/11/20 - Bug 30987030: Add OCI_REQUEST_BEGIN_RESERVED_2
                                        and OCI_REQUEST_END_RESERVED_4
                                        and OCI_ATTR_RESERVED_621 
   rajarsel    07/27/20 - Bug 31332374: add OCI_ATTR_SHRDID,OCI_INVALID_SHARD_ID
   joalvizo    07/20/20 - Bug 31537262: Remove OCIP_ATTR_LOB_IS_QUASI
   suummadi    07/15/20 - Bug 31504473: Change version release test
                          in macro from 19 to 18
   chenxma     06/19/20 - Bug 31220837: Hints for SODA monitoring
   joalvizo    06/16/20 - Remove OCI_ATTR_IS_VALUE_LOB
   chenxma     06/10/20 - Bug 31338769: Purge mode for DROP_COLLECTION
   xzhzhou     06/05/20 - bug 30786625: add OCI_ATTR_HA_PLANNED
   joalvizo    05/29/20 - Bug 31422985: Rename OCI_ATTR_IS_VALUE_LOB to 
                          OCI_ATTR_IS_LOB_VALUE
   ssonawan    05/13/20 - Bug 28844656: add OCI_ATTR_RESERVED_617
   rduraisa    01/20/20 - JIRA-VOS1973: Add instance types NANOVOS and ENGINE
   sriksure    01/08/20 - Bug 30734242: Add support for select for update
   kkverma     11/26/19 - Bug 30342371: add OCI_ATTR_ORAACCESS_CONNALIAS
   prramakr    11/04/19 - Bug 30333455: add OCI_PREP2_OCI_PLACEHOLDER mode
   ssubrama    09/19/19 - Bug 29761139: add OCI_EXEC_RESERVED_8
   yinliao     09/04/19 - Bug 30275540: Add OCI_PREP2_RESERVED_10
   ssahu       07/26/19 - Bug 28926840: Add mode for OCIServerRelease2
   rphillip    07/17/19 - Bug 30061848: Direct path dsb flag should be private
   prramakr    07/04/19 - proj 75757: OCI placeholder substitution
   jstenois    05/30/19 - Bug 29792213: add NUMERIC_CHARACTERS clause
   sriksure    06/24/19 - Bug 29903365: Add reuse storage option in SODA
                          truncate
   suhgarg     06/12/19 - Bug 27702196: add some OCI_STMT constants
   kkverma     06/07/19 - Bug 18792392: add OCI_INPUTVLD_CONNSTR_ATTR
   sriksure    05/08/19 - Bug 29750956: Add OCISodaCollTruncate()
   rkanodia    04/30/19 - Bug 29321709: add OCI_ATTR_SERVER_DATA_LEN attribute
   ...
   joalvizo    03/15/19 - Bug 29495146: Add OCI_ATTR_XMLTYPE_PROPERTIES
   shubhaku    01/22/19 - Proj 67702: define OCI_FO_AUTO
   vjitta      01/07/19 - Proj 32086: OCI NonBlocking Interface
   anjs        11/30/18 - Project 77247: add OCI_ATTR_SPOOL_DRAIN_TIMEOUT
   snechand    11/15/18 - Bug 28951139: add OCI_ATTR_IS_VALUE_LOB
   shubhaku    12/12/18 - Bug 28463805: Add OCI_ATTR_RESERVED_611
   ...
   rphillip    11/05/18 - XbranchMerge rphillip_bug-28449437 from
                          st_rdbms_pt-exadoop181
   sriksure    09/10/18 - Bug 28432345: Add support for flashbacks
   rphillip    08/20/18 - Decimal scaled binary
...
#define OCI_HTYPE_ASYNC                37                /* OCI Async handle */
#define OCI_HTYPE_PIPELINE_OPERATION   38          /* OCI Pipeline Operation */
#define OCI_HTYPE_RESERVED_39          39              /* Reserved Handle 39 */
#define OCI_HTYPE_PIPELINE             40              /* OCI Pipeline       */
#define OCI_HTYPE_LAST                 40     /* last value of a handle type */
...
#define OCI_DTYPE_JSON          85                   /* Json Descriptor Type */
#define OCI_DTYPE_DDL_EVENT     86       /* DDL Notification Descriptor Type */
#define OCI_DTYPE_VECTOR        87                 /* Vector Descriptor Type */
#define OCI_DTYPE_LAST          87        /* last value of a descriptor type */
...
/*--------------------------------KEY types ---------------------------------*/
#define OCIKeyType         ub2
#define OCI_KEYTYPE_STRING 1           /* KEY type - String ---------------- */
#define OCI_KEYTYPE_SB4    2           /* KEY type - SB4 ------------------- */
/*---------------------------------------------------------------------------*/
...
/* DDL Notification objects */
#define OCI_DDL_TABLE      0                                    /* TABLE DDL */
#define OCI_DDL_INDEX      1                                    /* INDEX DDL */

/* DDL Notification operations / operation filters */
#define OCI_DDL_CREATE     0x1                                 /* CREATE DDL */
#define OCI_DDL_ALTER      0x2                                  /* ALTER DDL */
#define OCI_DDL_DROP       0x4                                   /* DROP DDL */
#define OCI_DDL_RENAME     0x8                                 /* RENAME DDL */
#define OCI_DDL_FLASHBACK  0x10                       /* FLASHBACK TABLE DDL */
#define OCI_DDL_TRUNCATE   0x20                              /* TRUNCATE DDL */
#define OCI_DDL_PMOP       0x40                 /* PARTITION MAINTENANCE DDL */
...
#define OCI_SUBSCR_CQ_QOS_DDL_NTFN   0x08                /* ddl notification */
...
#define OCI_PIECEWISE         0x00000004                           /* unused */
...
#define OCI_BIND_RESERVED_4   0x00000400                         /* reserved */
/*---------------------------------------------------------------------------*/

/*-------------------- OCIStmtPlaceholderSubstitute Modes -------------------*/
#define OCI_SPS_NUMERIC_LITERAL    1          /* string is a numeric literal */
#define OCI_SPS_SIMPLE_SQL_NAME    2              /* string is a simple name */
#define OCI_SPS_QUALIFIED_SQL_NAME 3           /* string is a qualified name */
/*---------------------------------------------------------------------------*/

/*------------------- Common modes across OCI calls -------------------------*/
#define OCI_DEFAULT         0x00000000 
#define OCI_NON_BLOCKING    0x80000000                       /* non-blocking */
...
#define OCI_THREADED_V2     0x00000800            /* appl in threaded v2 env */                 
...
/*---------------------------------------------------------------------------*/
/***********************OCIPipelineAPIs **************************************/
           /* The following is mostly used for OCIPipelineEnd() */
#define OCI_PIPELINE_BLOCK  0x000000001 /* OCIPipelineEnd execute in blocking */
#define OCI_PIPELINE_PROCESS OCI_PIPELINE_BLOCK
/*------------------------OCIConnectionpoolCreate Modes----------------------*/

#define OCI_CPOOL_REINITIALIZE 0x0111
#define OCI_CPOOL_RESERVED_1   0x0002
...
/*---------------------------------------------------------------------------*/
/*-------------------------------- OCIServerRelease2 Modes ------------------*/

#define OCI_SRVRELEASE2_CACHED 0x0001
...
#define OCI_SPC_RESERVED_1   0x0010
/*---------------------------------------------------------------------------*/
/*--------------------------- OCISessionGet Modes ---------------------------*/
...
/*------------------- OCI_ATTR_SERVER_TYPE values ---------------------------*/
#define OCI_SERVER_TYPE_NONE      0
#define OCI_SERVER_TYPE_DEDICATED 1
#define OCI_SERVER_TYPE_SHARED    2
#define OCI_SERVER_TYPE_PSEUDO    3
#define OCI_SERVER_TYPE_POOLED    4
...
#define OCI_SPD_FORCE        0x0001       /* Force the sessions to terminate. 
                                             ...
                                             sessions close them */
#define OCI_SPD_DRAIN        0x0002       /* Force the session to terminate
                                             after specified timeout period.
                                             Includes busy sessions also */

/*---------------------------------------------------------------------------*/

/*---------------------------- OCIRequestBegin Modes ------------------------*/
#define OCI_REQUEST_BEGIN_RESERVED_1   0X0001                    /* reserved */
#define OCI_REQUEST_BEGIN_RESERVED_2   0x0002                    /* reserved */
#define OCI_REQUEST_BEGIN_RESERVED_4   0x0004                    /* reserved */
...
#define OCI_REQUEST_END_RESERVED_4   0X0004                      /* reserved */
...
#define OCI_SERVER_FLAG_CONFIG_USR         0x0001
#define OCI_SERVER_FLAG_CONFIG_PASSWORD    0x0002
...
#define OCI_EXEC_RESERVED_8        0x00200000                    /* reserved */
#define OCI_EXEC_RESERVED_9        0x00400000                    /* reserved */
/*---------------------------------------------------------------------------*/
...
#define OCI_SESSEND_RESERVED_3 0x0004                            /* reserved */
/*---------------------------------------------------------------------------*/
...
#define OCI_PREP2_RESERVED_10         0x20000                    /* reserved */
#define OCI_PREP2_OCI_PLACEHOLDER     0x40000                    /* reserved */
#define OCI_PREP2_RESERVED_11         0x80000                    /* reserved */
#define OCI_PREP2_RESERVED_12         0x100000                   /* reserved */
...
/*--------------------- Input String Validation Modes -----------------------*/
#define OCI_INPUTVLD_CONNSTR_ATTR  0x00000001 /* Validate connStr Attributes */
...
#define OCI_TRANS_PROMOTE      0x00000008 /* promote the local txn to global */
                            /* 0x00000010       is used below as a type flag */
#define OCI_TRANS_STARTMASK    0x000000ef  /* mask for start operation flags */
...
#define OCI_TRANS_RESUMABLE    0x00000010  /* a resumable transaction branch */
#define OCI_TRANS_SESSIONLESS  OCI_TRANS_RESUMABLE  /* Resumable transaction */
                                   /* is renamed to Sessionless Transactions */
#define OCI_TRANS_TYPEMASK     0x000f0010      /* mask for branch type flags */
...
/*---------------------- Transaction Suspend Flags --------------------------*/
#define OCI_TRANS_PRE_CALL     0x00000001   /* suspend before next main call */
#define OCI_TRANS_POST_CALL    0x00000002    /* suspend after next main call */
                            /* 0x00000010       is used above as a type flag */
#define OCI_TRANS_SUSPENDMASK  0x000000ef          /* mask for suspend flags */
/*---------------------------------------------------------------------------*/
...
/* ------------------------- Shard ID ---------------------------------------*/
#define OCI_INVALID_SHARD_ID    UB4MAXVAL
...
#define OCI_AQ_RESERVED_6      0x04000000
...
/* SAGA coordinator types */
#define OCI_SAGA_DEFAULT_COORDINATOR  1
#define OCI_SAGA_EXTERNAL_COORDINATOR 2
/*----------------------Password Callback Modes -----------------------------*/
#define OCI_PASSWORD_UPDATE   0x00000001                  /* update password */ 
...
#define OCI_ATTR_COL_PROPERTY_HAS_DOMAIN            0x0000000000000020
#define OCI_ATTR_COL_PROPERTY_HAS_ANNOTATIONS       0x0000000000000040
...
#define OCI_ATTR_JSON_COL                  534   /* column holding JSON data */
...
/* OCI JSON attributes */
#define OCI_ATTR_JSON_DOM_MUTABLE               609

#define OCI_ATTR_RESERVED_610                   610
#define OCI_ATTR_RESERVED_611                   611

#define OCI_ATTR_LOB_IS_VALUE                   612       /* value based lob */

#define OCI_ATTR_SPOOL_DRAIN_TIMEOUT            613

/* XMLType properties */
#define OCI_ATTR_XMLTYPE_PROPERTIES             614

/* Placeholder substituted statement */
#define OCI_ATTR_FINAL_STATEMENT                615
/* oraaccess.xml connect alias */
#define OCI_ATTR_ORAACCESS_CONNALIAS            616

#define OCI_ATTR_RESERVED_617                   617

/*  HA event is planned or not */
#define OCI_ATTR_HA_PLANNED                     618

#define OCI_ATTR_LOB_IS_READONLY                619         /* read-only lob */

#define OCI_ATTR_RESERVED_620                   620

/* TEQ shardID */
#define OCI_ATTR_SHARD_ID                       621

#define OCI_ATTR_RESERVED_622                   622

/* More OCI SODA attributes */
#define OCI_ATTR_OSON_COL                       623 /* col with OSON content */
#define OCI_ATTR_SODA_METADATA_CACHE            624

#define OCI_ATTR_CONNECTION_ID                  624         /* Connection ID */

/* port range for listening end-point */
#define OCI_ATTR_SUBSCR_PORTRANGE               625

#define OCI_ATTR_RESERVED_626                   626

/* More OCI SODA attributes */
#define OCI_ATTR_SODA_HINT                      627

/* This column has IS JSON check constraint */
#define OCI_ATTR_HAS_IS_JSON_CONSTRAINT         628 

#define OCI_ATTR_RESERVED_629                   629

#define OCI_ATTR_RESERVED_630                   630              /* reserved */

#define OCI_ATTR_SODA_SAMPLE_PCT                631
#define OCI_ATTR_SODA_SAMPLE_SEED               632
#define OCI_ATTR_SODA_SAMPLE_METHOD             633

#define OCI_ATTR_RESERVED_634                   634              /* reserved */

#define OCI_ATTR_RESERVED_635                   635              /* reserved */

#define OCI_ATTR_TOKEN                          636   /* PoP or Bearer Token */
#define OCI_ATTR_IAM_TOKEN                      OCI_ATTR_TOKEN

#define OCI_ATTR_IAM_PRIVKEY                    637  /*DBIAM Auth Private Key*/

/* IAM OAUTH token callback function */
#define OCI_ATTR_TOKEN_CBK                      638
#define OCI_ATTR_IAM_CBK                        OCI_ATTR_TOKEN_CBK

/* IAM OAUTH token callback context */
#define OCI_ATTR_TOKEN_CBKCTX                   639
#define OCI_ATTR_IAM_CBKCTX                     OCI_ATTR_TOKEN_CBKCTX

#define OCI_ATTR_RESERVED_640                   640              /* reserved */
/* True Cache Service name for session */
#define OCI_ATTR_TRUE_CACHE_SERVICE             641

#define OCI_ATTR_HAS_JSON_SCHEMA                642

#define OCI_ATTR_RESERVED_643                   643

#define OCI_ATTR_RESERVED_644                   644 
#define OCI_ATTR_RESERVED_645                   645
#define OCI_ATTR_RESERVED_646                   646              /* reserved */
                                                        /* 647 can be reused */
#define OCI_ATTR_PIPELINE_OPER_STATE            648
/* operation status */
#define OCI_ATTR_PIPELINE_OP_STATUS             649
#define OCI_ATTR_PIPELINE_STATUS                650
/* Used to set operation level mode attribute */  
#define OCI_ATTR_PIPELINE_OP_MODE               651
/* Pipeline Block  */
#define OCI_ATTR_PIPELINE_BLOCK                 652
#define OCI_ATTR_PIPELINE_ENABLE                653

#define OCI_ATTR_RESERVED_654                   654              /* reserved */

#define OCI_ATTR_PING_INTERVAL                  655         /* ping interval */
#define OCI_ATTR_SESSSTATE_CONSISTENCY          656/* sess state consistency */

/* OUATH2 bearer token new attributes */
#define OCI_ATTR_TOKEN_ISBEARER                 657        /* is Bearer auth */
#define OCI_ATTR_SERVER_SESSLANG                658 /* session lang handle   */

/* SQL Domains handle attributes */
#define OCI_ATTR_DOMAIN_SCHEMA                  659
#define OCI_ATTR_DOMAIN_NAME                    660

/* TDM Stats counters */
#define OCI_ATTR_SPOOL_HIT_COUNT                661     /* session reused    */
 
#define OCI_ATTR_SPOOL_HISTMAX_COUNT            662     /* Max size reached  */
 
#define OCI_ATTR_SPOOL_WAIT_TOTAL_COUNT         663     /* Aggregated count  */
 
#define OCI_ATTR_SPOOL_WAIT_COUNT               664     /* Active count      */
 
#define OCI_ATTR_SPOOL_REQ_COUNT                665    /* OCISessionGet count*/

/* Table DDL notification attributes */
#define OCI_ATTR_DDL_EVENT_TIME                 666     /* modification time */
#define OCI_ATTR_DDL_EVENT_DBNAME               667       /* source database */
#define OCI_ATTR_DDL_EVENT_OBJECT_NAME          668           /* object name */
#define OCI_ATTR_DDL_EVENT_OPERATION            669       /* table operation */
#define OCI_ATTR_DDL_EVENT_OBJECT_TYPE          670           /* object type */
#define OCI_ATTR_DDL_EVENT_CSCN                 671        /* DDL commit scn */
#define OCI_ATTR_DDL_EVENT_OBJECT_OWNER         672          /* object owner */

#define OCI_ATTR_SODA_CLIENT_ERROR              673
#define OCI_ATTR_SODA_DUALITY_VIEW_NAME         674
#define OCI_ATTR_SODA_JSON_DESC                 675
#define OCI_ATTR_SUPPRESS_ERROR_URL             676

/* Send all LOB data for value LOBs */
#define OCI_ATTR_VBL_SEND_ALL_LOB_DATA          677

#define OCI_ATTR_RESERVED_678                   678
#define OCI_ATTR_RESERVED_679                   679
#define OCI_ATTR_PIPELINE_HANDLE                680           /*Current handle*/
#define OCI_ATTR_PIPELINE_HANDLE_TYPE           681          /*Types of handle*/
#define OCI_ATTR_SODA_KEY_PATH                  682
#define OCI_ATTR_SERVER_FLAGS                   683          /* Server flags */
#define OCI_ATTR_RESERVED_684                   684
#define OCI_ATTR_SUBSCR_PAYTYPE                 685   /* Subscr Payload Type */

#define OCI_ATTR_PASSWORD_CALLBACK              OCI_ATTR_TOKEN_CBK 
                                                          /* password callbk */
#define OCI_ATTR_PASSWORD_CALLBACK_CTX          OCI_ATTR_TOKEN_CBKCTX
                                                          /* password cbkctx */
#define OCI_ATTR_LIST_ANNOTATIONS               686 /* annotations attribute */  
#define OCI_ATTR_NUM_ANNOTATIONS                687 /* number of annotations */  
#define OCI_ATTR_ANNOTATION_KEY                 688   /* annotation key text */  
#define OCI_ATTR_ANNOTATION_VALUE               689 /* annotation value text */  
#define OCI_ATTR_RESERVED_690                   690
#define OCI_ATTR_PIPELINE_PROCESS_FIRST         691   
                           /* ID of the first operation in the pipeline queue*/
#define OCI_ATTR_PIPELINE_PROCESS_LAST          692     
                               /* ID of last operation in the pipeline queue */
#define OCI_ATTR_PIPELINE_DEPTH                 693 
                                               /* Size of the pipeline queue */
#define OCI_ATTR_SERVER_TYPE                    694           /* Server type */
#define OCI_ATTR_VECTOR_DIMENSION               695
                                                 /* Dimension of vector type */
#define OCI_ATTR_VECTOR_DATA_FORMAT             696
                                                 /* Format of data in vector */
#define OCI_ATTR_VECTOR_PROPERTY                697
                                                        /* vector properties */
#define OCI_ATTR_RESERVED_698                   698
#define OCI_ATTR_RESERVED_699                   699
#define OCI_ATTR_RESERVED_700                   700
#define OCI_ATTR_RESERVED_701                   701
#define OCI_ATTR_VECTOR_CHARSET_ID              702
               /* Character set id data in textual vector data in descriptor */
#define OCI_ATTR_VECTOR_ERROR_POSITION          703
                                            /* Error position in Vector data */
#define OCI_ATTR_SODA_NATIVE                    704
                                                  /* SODA: Native collection */
#define OCI_ATTR_RESERVED_705                   705
#define OCI_ATTR_RESERVED_706                   706
#define OCI_ATTR_RESERVED_707                   707
#define OCI_ATTR_RESERVED_708                   708
#define OCI_ATTR_RESERVED_709                   709
#define OCI_ATTR_RESERVED_710                   710
#define OCI_ATTR_RESERVED_711                   711
#define OCI_ATTR_VECTOR_MAX_STRING_SIZE         712
                     /* maximum size of string representation of vector data */
#define OCI_ATTR_LAST                           712
                            /* updated for the highest value in oci_attr_*** */
...
/*---------------------------------------------------------------------------*/
/*
 * NEW ATTRIBUTES MUST BE ADDED TO kpdAttrNames IN kpu.c
 * NEW ATTRIBUTES MUST BE ADDED JUST BEFORE THIS BLOCK
 * For every new attribute added the value of OCI_ATTR_LAST must be updated
 *
...
/* Table DDL Notification Filter Values */
#define OCI_DDL_EVENT_FILTER_TABLE     1       /* table level registration */
#define OCI_DDL_EVENT_FILTER_SCHEMA    2      /* schema level registration */
#define OCI_DDL_EVENT_FILTER_DATABASE  3    /* database level registration */

/* OCI NonBlocking Attributes */                
#define OCI_NONBLOCKING_FD_IN_WRITE                0x01
#define OCI_NONBLOCKING_FD_IN_READ                 0x02

#define OCI_ASYNC_FD_IN_WRITE                      OCI_NONBLOCKING_FD_IN_WRITE
#define OCI_ASYNC_FD_IN_READ                       OCI_NONBLOCKING_FD_IN_READ

/* following are the possible status */
#define OCI_PIPELINE_DATA_READY          1
#define OCI_PIPELINE_OP_SENT             2
/* Possible values for Pipeline mode */  
#define OCI_PIPELINE_CONT_ON_ERROR       1  
#define OCI_PIPELINE_ABORT_ON_ERROR      2



/*-------------------------- OCI XMLTYPE PROPERTIES -------------------------*/
#define OCI_XML_PROP_TRANSPORTABLE 0x01

/*------------------------------ OCI JSON Flags -----------------------------*/
/* OCI JSON formats */
/* Values for Content Column Format attribute */
#define  OCI_JSON_FORMAT_JSON    0                    /* Textual JSON format */
#define  OCI_JSON_FORMAT_OSON    1                     /* Binary OSON format */
...
#define OCI_SODA_AS_STORED            0x00000002
                                   /* Retrieve as stored in BLOB/JSON column */
#define OCI_SODA_AS_AL32UTF8          0x00000004        /* Retrieve as UTF-8 */
#define OCI_SODA_JSON_DESC            0x00000008
                                               /* Content as JSON descriptor */

/* OCI SODA key validation methods */
...
#define  OCI_SODA_KEY_METHOD_SERVER     5
#define  OCI_SODA_KEY_METHOD_EMBED_OID  6

/* OCI SODA JSON content validation methods */
#define  OCI_SODA_JSON_VALIDATION_STRICT  1
#define  OCI_SODA_JSON_VALIDATION_LAX     2 
#define  OCI_SODA_JSON_VALIDATION_STD     3

/* OCI SODA LOB compression levels */
...
/* OCI SODA LOB encryption mechanisms */
...
/* OCI SODA version generation methods */
...
/* OCI SODA sampling method */
#define  OCI_SODA_SAMPLE_METHOD_ROW       1
#define  OCI_SODA_SAMPLE_METHOD_BLOCK     2

#define  OCI_SODA_SAMPLE_NO_SEED         -1
                                       /* Seed value not needed for sampling */
...
#define OCI_ATTR_DIRPATH_RESERVED_36       2037                  /* reserved */

#define OCI_ATTR_DIRPATH_RESERVED_37       2038                  /* reserved */

#define OCI_ATTR_DIRPATH_RESERVED_38       2039                  /* reserved */
...
#define OCI_INSTANCE_TYPE_NANOVOS  5
#define OCI_INSTANCE_TYPE_ENGINE   6
#define OCI_INSTANCE_TYPE_TDM      7
...
#define OCI_PING_NEVER  (-1)          /* no ping call for session validation */
#define OCI_PING_ALWAYS  0         /* always ping call for session validation*/
#define OCI_MAX_PING_INTERVAL   3600              /* max ping interval value */
/*---------------------------------------------------------------------------*/
...
#define OCI_FO_BEGIN_EXPIREDTOKEN 0x00000020
/*---------------------------------------------------------------------------*/
...
#define OCI_FNCODE_SODACOLLCREATEWITHMETADATA 158 
...
#define OCI_FNCODE_SODADOCCREATEWITHKEYANDMTYPE 162
...
#define OCI_FNCODE_SODAREPLONEANDGETWITHCTNT 185
                                             /* OCISodaReplOneAndGetWithCtnt */
#define OCI_FNCODE_SODAREPLONEWITHKEY     186       /* OCISodaReplOneWithKey */
#define OCI_FNCODE_SODAREPLONEANDGETWITHKEY 187
...
#define OCI_FNCODE_JSONBINARYBUFFERLOAD   199     /* OCIJsonBinaryBufferLoad */
#define OCI_FNCODE_JSONBINARYLENGTHGET    200      /* OCIJsonBinaryLengthGet */
#define OCI_FNCODE_JSONBINARYSTREAMLOAD   201     /* OCIJsonBinaryStreamLoad */
#define OCI_FNCODE_JSONCLONE              202                /* OCIJsonClone */
#define OCI_FNCODE_JSONDOMDOCGET          203            /* OCIJsonDomDocGet */
#define OCI_FNCODE_JSONDOMDOCSET          204            /* OCIJsonDomDocSet */
#define OCI_FNCODE_JSONTEXTBUFFERPARSE    205      /* OCIJsonTextBufferParse */
#define OCI_FNCODE_JSONTEXTSTREAMPARSE    206      /* OCIJsonTextStreamParse */
#define OCI_FNCODE_JSONTOBINARYBUFFER     207       /* OCIJsonToBinaryBuffer */
#define OCI_FNCODE_JSONTOBINARYSTREAM     208       /* OCIJsonToBinaryStream */
#define OCI_FNCODE_JSONTOTEXTBUFFER       209         /* OCIJsonToTextBuffer */
#define OCI_FNCODE_JSONTOTEXTSTREAM       210         /* OCIJsonToTextStream */
#define OCI_FNCODE_NONBLOCKINGENABLE      211       /* OCINonbBlockingEnable */
#define OCI_FNCODE_NONBLOCKINGDISABLE     212       /* OCINonBlockingDisable */
#define OCI_FNCODE_NONBLOCKINGFDGET       213         /* OCINonBlockingFdGet */
#define OCI_FNCODE_ASYNCENABLE            214              /* OCIAsyncEnable */ 
#define OCI_FNCODE_ASYNCFDGET             215               /* OCIAsyncFdGet */
#define OCI_FNCODE_ASYNCCOROUTINESUBMIT   216     /* OCIAsyncCoroutineSubmit */
#define OCI_FNCODE_ASYNCWAITONE           217             /* OCIAsyncWaitOne */
#define OCI_FNCODE_ASYNCWAITMANY          218            /* OCIAsyncWaitMany */
#define OCI_FNCODE_ASYNCCOROUTINERESUME   219     /* OCIAsyncCoroutineResume */
#define OCI_FNCODE_ASYNCCOROUTINEABORT    220      /* OCIAsyncCoroutineAbort */
#define OCI_FNCODE_ASYNCDISABLE           221             /* OCIAsyncDisable */ 
#define OCI_FNCODE_SERVERDATALENGET       222      /* OCIServerDataLengthGet */
#define OCI_FNCODE_SODACOLLTRUNCATE       223         /* OCISodaCollTruncate */
#define OCI_FNCODE_PLACEHOLDERSUBSTITUTE  224
...
#define OCI_FNCODE_SODAINDEXGET           231             /* OCISodaIndexGet */
#define OCI_FNCODE_SODAINDEXLIST          232            /* OCISodaIndexList */
#define OCI_FNCODE_JSONSCHEMAVALIDATE     233       /* OCIJsonSchemaValidate */
#define OCI_FNCODE_PIPELINEPROCESS        234          /* OCIPipelineProcess */
#define OCI_FNCODE_PIPELINEBEGIN          235            /* OCIPipelineBegin */ 
#define OCI_FNCODE_PIPELINEEND            236              /* OCIPipelineEnd */
#define OCI_FNCODE_REQUESTBEGIN           237             /* OCIRequestBegin */
#define OCI_FNCODE_REQUESTEND             238               /* OCIRequestEnd */
#define OCI_FNCODE_SAGABEGIN              239                /* OCISagaBegin */
#define OCI_FNCODE_SAGAJOIN               240                 /* OCISagaJoin */
#define OCI_FNCODE_SAGACOMMIT             241               /* OCISagaCommit */
#define OCI_FNCODE_SAGAROLLBACK           242             /* OCISagaRollback */
#define OCI_FNCODE_VECTOR_FROM_TEXT       243           /* OCIVectorFromText */
#define OCI_FNCODE_VECTOR_TO_TEXT         244             /* OCIVectorToText */
#define OCI_FNCODE_VECTOR_FROM_ARRAY      245          /* OCIVectorFromArray */
#define OCI_FNCODE_VECTOR_TO_ARRAY        246            /* OCIVectorToArray */
#define OCI_FNCODE_MAXFCN                 246   /* maximum OCI function code */

/*---------------Statement Cache callback modes-----------------------------*/
#define OCI_CBK_STMTCACHE_STMTPURGE  0x01

/*----------------OCI_ATTR_SESSSTATE_CONSISTENCY values----------------------*/
#define OCI_SESSSTATECONS_DYNAMIC     0x00000008
#define OCI_SESSSTATECONS_RESERVED_16 0x00000010
#define OCI_SESSSTATECONS_AUTO        0x00000020
#define OCI_SESSSTATECONS_HYBRID      0x00000100
/*---------------------------------------------------------------------------*/
...
typedef struct OCIJson          OCIJson;              /* OCI Json Descriptor */
...
/*---------------------------------------------------------------------------*/
/* OCI Async handle */
typedef struct OCIAsync OCIAsync;
typedef sword (*OCIAsyncCoroutine) (OCIEnv   *envhp,
                                    OCIError *errhp,
                                    OCIAsync *asynchp,
                                    void     *coroutinehp,
                                    void     *ctx);
...
typedef ub8 OCIPipelineOperationID;

#define OCI_PIPELINE_OPER_READ_READY   0x00
#define OCI_PIPELINE_OPER_EAGAIN       0x01
/* OCI Pipeline Operation handle */
typedef struct OCIPipelineOperation OCIPipelineOperation;
typedef sword (*OCIPipelineOpCbk) (OCISvcCtx            *svchp,
                                   OCIPipelineOperationID oID,
                                   OCIPipelineOperation *future,
                                   sword                operationStatus,
                                   void                 *callbackCtx,
                                   OCIError             *errhp);
/*---------------------------------------------------------------------------*/
...
#define  OCI_STMT_ROLLBACK 17                          /* rollback statement */
#define  OCI_STMT_COMMIT   21                            /* commit statement */
...
#define OCI_PTYPE_KEY_VALUE           27   /* key-value pair with text value */
/*---------------------------------------------------------------------------*/
