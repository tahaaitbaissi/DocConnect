...
/*
 * $Header: security_src/include/public/nz/nzerror.h /main/90 2023/10/06 19:41:03 akadian Exp $
 *
...
/*
  ...
  MODIFIED
     akadian    09/18/23 - Improve wallet reading performance
     anna       11/13/22 - Bug 34538176: Minimum Security Strength Feature
     mstavar    09/21/21 - Add FIPS lib missing error
     rchahal    09/14/21 - v7 LSSO wallet
     anna       04/03/20 - Error code NZERROR_EMPTY_CRL added for no revoked
                           certs in CRL (Crypto-651)
     akadian    02/11/19 - Bug 29295652 - HOSTNAME VALIDATION ISSUE WITH CERTIFICATE SUBJECT DN HAVING NO COMMON NAME
...
/* ============>>> FIPS ERRORS 29150 - 29175 */
  ...
  NZERROR_UNKNOWN_KEYSIZE = 29167,
  NZERROR_FIPS_LIBRARY_NOT_FOUND = 29168,
  NZERROR_BAD_KEYSIZE = 29169,
  NZERROR_EXTERNAL_PKCS12_FOUND = 29170,
...
/* ============>>> CRL ERRORS 29176 - 29200 */
  ...
  NZERROR_CRL_CACHE_FULL = 29197,    /*!< CRL could not be added in CRL cache,
                 CRL cache max size < (CRL cache current size + input CRL size)
                                     */
  NZERROR_EMPTY_CRL = 29198,         /*!< No revoked cert in CRL*/ 
...
/* ============>>>  ADD ERRORS HERE -- NOTE DECREASING numbers */
  ...
  NZERROR_INVALID_CONN_REF = 43143,        /*!< Connection reference pointer set in SSL object is invalid */

  NZERROR_LSSO_SSVS_NOT_SET = 43144,      /*!< v7 LSSO SSVs not set */ 
  NZERROR_LSSO_MACNAME0_NOT_SET = 43145,      /*!< v7 LSSO: Macname0 bit set in mask but Macname0 string not set */
  NZERROR_LSSO_MACNAME1_NOT_SET = 43146,      /*!< v7 LSSO: Macname1 bit set in mask but Macname1 string not set */
  NZERROR_LSSO_BIOS_SERNUM_NOT_AVAILABLE = 43147, /*!< LSSO: BIOS Serial Number could not be fetched */
  NZERROR_LSSO_BIOS_UUID_NOT_AVAILABLE = 43148, /*!< LSSO: BIOS UUID could not be fetched */
  NZERROR_LSSO_MACHINEID_NOT_AVAILABLE = 43149, /*!< LSSO: Machine ID could not be fetched */
  NZERROR_LSSO_GENERIC0_NOT_AVAILABLE = 43150, /*!< LSSO: Generic0 could not be fetched */
  NZERROR_LSSO_GENERIC1_NOT_AVAILABLE = 43151, /*!< LSSO: Generic1 could not be fetched */
  NZERROR_LSSO_MACNAME0_NOT_AVAILABLE = 43152, /*!< LSSO: Macname0 could not be fetched */
  NZERROR_LSSO_MACNAME1_NOT_AVAILABLE = 43153, /*!< LSSO: Macname1 could not be fetched */
  NZERROR_LSSO_MACNAME0_TOO_LONG = 43154,      /*!< v7 LSSO: Macname0 should be fewer than 32 chars long */
  NZERROR_LSSO_MACNAME1_TOO_LONG = 43155,      /*!< v7 LSSO: Macname1 should be fewer than 32 chars long */
  NZERROR_LSSO_SSV_NOT_VALID = 43156,          /*!< v7 LSSO invalid SSV */ 
...
/**
 * \brief SSl errors to Oracle errors
 *
